...
-- Tuesday
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'b',3,'00:00:00','9:59:59',0);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'b',3,'10:00:00','11:59:59',90);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'b',3,'12:00:00','12:59:59',10);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'b',3,'13:00:00','14:59:59',90);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'b',3,'15:00:00','23:59:59',0);

insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'c',3,'00:00:00','11:59:59',0);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'c',3,'12:00:00','17:59:59',90);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'c',3,'18:00:00','23:59:59',0);

insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'a',3,'00:00:00','7:59:59',0);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'a',3,'8:00:00','10:59:59',90);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'a',3,'11:00:00','11:59:59',10);
insert into open_possibility_table(room_id,day_of_week,start_time,end_time,open_posibility) values( 'a',3,'12:00:00','23:59:59',0);
