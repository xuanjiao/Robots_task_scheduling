...
SQLClient::SQLClient(string user_name, string pass){
    ConnectToDatabase(user_name,pass);
  }


  void SQLClient::ConnectToDatabase(string user_name, string pass){
    _sqlMtx.lock();
  ...
  // truncate table
  void SQLClient::TruncateTable(string name){
    _sqlMtx.lock();
  ...
  TaskWeight SQLClient::QueryTaskWeight(){
    _sqlMtx.lock();
    sql::ResultSet* res;
    TaskWeight tw;
    ...
    DoorWeight SQLClient::QueryDoorWeight(){
    _sqlMtx.lock();
    sql::ResultSet* res;
    DoorWeight dw;
  ...
  SQLClient::QueryTargetPositionAndOpenPossibilities(string time){
    _sqlMtx.lock();
    sql::ResultSet* res;
  ...
  SQLClient::QueryRunableExecuteTasks(int robotId){
    _sqlMtx.lock();
    sql::ResultSet* res;
  ...
  SmallTask SQLClient::QueryRunableChargingTask(int robotId){
    _sqlMtx.lock();
    sql::ResultSet* res;
    SmallTask t;
    res = stmt->executeQuery(
  ...
  int SQLClient::QueryRoomWithCoordinate(geometry_msgs::Pose robotPose){
    int roomId = 0;
  ...
  vector<Door> SQLClient::QueryDoorInfo(){
  ...
  vector<double> SQLClient::QueryRelativeDoorOpenPossibility(set<int>& doors, ros::Duration waitingTime ){
    vector<double> v;
    _sqlMtx.lock();
    sql::ResultSet* res;
  ...
  ChargingStation SQLClient::QueryChargingStationInfo(int stationId){
    _sqlMtx.lock();
    sql::ResultSet* res;
    ChargingStation cs;
    res = stmt->executeQuery( 
  ...
  vector<ChargingStation> SQLClient::QueryChargingStationInfo(){
    _sqlMtx.lock();
    sql::ResultSet* res;
  ...
  int SQLClient::InsertATaskAssignId(SmallExecuteTask& t){
    _sqlMtx.lock();
      sql::ResultSet* res;        
      stmt->execute(
  ...
  int SQLClient::InsertATaskAssignId(SmallTask& t){
    _sqlMtx.lock();
    sql::ResultSet* res;        
    stmt->execute(
  ...
  int SQLClient::InsertATargetAssignId(geometry_msgs::PoseStamped target, string targetType){
    _sqlMtx.lock();
    int id = 0;
    sql::ResultSet* res;        
  ...
  int SQLClient::UpdateFailedExecuteTask(const vector<int>& taskIds){
    _sqlMtx.lock();
    stringstream ss;
    ss<<"(";
  ...
  int SQLClient::InsertDoorStatusRecord(int door_id, ros::Time measure_time,bool door_status){
    _sqlMtx.lock();
  ...
  int SQLClient::UpdateOpenPossibilities(int door_id, ros::Time measure_time){
    _sqlMtx.lock();
  ...
  int SQLClient::UpdateTaskStatus(int taskId,string status){
    _sqlMtx.lock();
  ...
  int SQLClient::UpdateTaskDescription(int taskId, string description){
    _sqlMtx.lock();
  ...
  int SQLClient::UpdateTaskRobotId(int taskId, int robotId){
    _sqlMtx.lock();
  ...
  int SQLClient::UpdateChargingStationInfo(const ChargingStation& cs){
    _sqlMtx.lock();
  ...
  int SQLClient::UpdateTaskEndTime(int taskId){
    _sqlMtx.lock();
    int ret = stmt->executeUpdate(
  ...
  bool SQLClient::CallNewExpProcedure(){
    _sqlMtx.lock();
    bool ret = false;
   ...
   bool SQLClient::CallNewEnvExpProcedure(){
    _sqlMtx.lock();
    bool ret = false;
  ...
  void SQLClient::CallFinishExpProcedure(){
    _sqlMtx.lock();
